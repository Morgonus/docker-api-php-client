...
class ServiceResource extends Resource
{
     ...
     */
    public function create(\Docker\API\Model\ServiceSpec $serviceSpec, $parameters = array(), $fetch = self::FETCH_OBJECT)
    {
        $queryParam = new QueryParam();
     ...
     * @return \Psr\Http\Message\ResponseInterface
     */
    public function update($id, \Docker\API\Model\ServiceSpec $serviceSpec, $parameters = array(), $fetch = self::FETCH_OBJECT)
    {
        $queryParam = new QueryParam();
