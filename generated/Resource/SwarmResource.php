...
class SwarmResource extends Resource
{
     ...
     */
    public function initialize(\Docker\API\Model\SwarmConfig $swarmConfig, $parameters = array(), $fetch = self::FETCH_OBJECT)
    {
     ...
     * @return \Psr\Http\Message\ResponseInterface
     */
    public function join(\Docker\API\Model\SwarmJoinConfig $swarmJoinConfig, $parameters = array(), $fetch = self::FETCH_OBJECT)
    {
        $queryParam = new QueryParam();
     ...
     * @return \Psr\Http\Message\ResponseInterface
     */
    public function leave($parameters = array(), $fetch = self::FETCH_OBJECT)
    {
        $queryParam = new QueryParam();
     ...
     * @return \Psr\Http\Message\ResponseInterface
     */
    public function update(\Docker\API\Model\SwarmUpdateConfig $swarmUpdateConfig, $parameters = array(), $fetch = self::FETCH_OBJECT)
    {
        $queryParam = new QueryParam();
